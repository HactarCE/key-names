...
/// Returns the best guess at a virtual key code from a key map (which
/// corresponds to physical key). This is not used on Windows and Linux, where
/// we can query the OS for the mapping.
#[cfg(feature = "winit")]
